...
const API_URL ='https://wu89z93mp4.execute-api.us-west-2.amazonaws.com/dev/authentication/confirm-signup'
...
export default class Profile extends Component {
  ...
  componentDidMount = () => {
    const { userid, code ,email } = this.props.match.params

    fetch(`${API_URL}/email/confirm/${userid,code,email}`)
      .then(res => res.json())
      .then(data => {
